...
python -m pydeps ../Zontromat/plugins/ac/ac.py --max-bacon 33 --cluster --max-cluster-size 10 --noise-level 33 --include-missing --keep-target-cluster --rmprefix data. services. bgERP. devices. controllers. plugins. utils. sys. -o ../Zontromat/plugins/ac/ac.svg --show-deps # > ../Zontromat/plugins/ac/dep_graph.json
