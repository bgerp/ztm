...
| Purpose | Register | Type | Value |
|----------|:-------------|:------|:------|
| Window 1 blinds mechanism | blinds.blind_1.mechanism | json | {'vendor': 'Yihao', 'model': 'BlindsV2', 'options': {'output_cw': 'off', 'output_ccw': 'off', 'feedback': 'off', 'feedback_tresh': 0.093, 'min': 0, 'max': 180, 'deg_per_sec': 10.0}} |
