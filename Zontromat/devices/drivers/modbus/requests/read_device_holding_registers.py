...
class ReadDeviceHoldingRegisters(ReadHoldingRegistersRequest):
    """Read device holding registers.
    """
    ...
    def __init__(self, unit, address, count):
        ...
        ReadHoldingRegistersRequest.__init__(self, address, count, unit=unit)
