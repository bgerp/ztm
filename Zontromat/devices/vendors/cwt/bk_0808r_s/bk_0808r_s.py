...
class MB308V(ModbusDevice):
    """This class is dedicated to read/write data from CWT-BK-0808R-S GPIO expander.

     - See: https://store.comwintop.com/products/cwt-bk-0808r-s-8di-8do-digital-input-and-output-rs485-modbus-io-module-modbus-rtu
    """
