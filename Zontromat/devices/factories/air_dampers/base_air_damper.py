...
class BaseAirDamper(BaseDevice):
    """Air damper base class."""
...
#region Constructor
    ...
    def __init__(self, config):
        ...
        self._state = StateMachine(AirDamperState.NONE)
...
#region Properties
    ...
    def target_position(self, position):
        ...
        self._state.set_state(AirDamperState.Prepare)
...
#region Public Methods
    ...
    def shutdown(self):
        ...
        while not self._state.is_state(AirDamperState.Wait):
            self.update()
