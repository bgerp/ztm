...
def test_function():
    ...
    parser.add_argument("--voltage", type=int, default=0, help="Voltage")
    parser.add_argument("--mji", type=int, default=1, help="Majore Index")
    ...
    device = __neuron.set_analog_output(args.mji, args.mii, voltage)
...
def main():
    ...
    print('Analog output test; Time: %.3f' % round(test_function, 3))
